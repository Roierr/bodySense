...
# Dibujo un hueso entre dos puntos 3D como un cilindro para representar el esqueleto
def dibujar_hueso(p1, p2, color):
    ...
    # Dibujo el cilindro entre p1 y p2

    glPushMatrix()
    glTranslatef(x1, y1, z1)
    # Calculo los ángulos de rotación
    ax = 57.29578 * math.atan2(dy, dx)
    if dx < 0: ax += 180
    # Roto el cilindro para alinearlo entre los dos puntos
    ...
    # Tapo los extremos del cilindro 
    glPopMatrix()

# Dibujo una esfera para representar una articulación del esqueleto en 3D
...
# Dibujo la cabeza como una esfera en 3D
